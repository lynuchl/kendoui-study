 ...
 * Copyright 2018-2020 IKKI Studio
...
function showBigPic(url) {
    ...
    picWindow.content('<div class="position-absolute w-100 h-100 d-flex justify-content-center align-items-center"><img src="'+ url +'" style="max-width: 100%; max-height: 100%;"></div>').center().open().maximize();
}
